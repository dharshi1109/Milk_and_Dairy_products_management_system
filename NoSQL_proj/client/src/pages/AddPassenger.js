...
function AddPassenger() {
  ...
  const handleSubmit = async (e) => {
   ...
   {
    console.log(error);
    message.error('11something went wrong');
   }
  };
  ...
  return (
    <div className="add-passenger-container">
      ...
      <form layout="vertical" onSubmit={handleSubmit}>
        ...
        <fieldset><legend>Travelling Details</legend>
        <div className="form-group">
          <label htmlFor="bookingHistory">Booking History (Enter each PNR No on a new line):</label>
          <textarea
            id="bookingHistory"
            name="bookingHistory"
        ...
        <div className="form-group">
          <label htmlFor="cancellationHistory">Cancellation History (Enter each PNR No on a new line):</label>
          <textarea
            id="cancellationHistory"
            name="cancellationHistory"
