...
const Query3 = () => {
  ...
  const handleQuerySubmit = async () => {
    try {
      ...
      const apiUrl = `/api/v1/analytics/query3?startDate=${startDate.format(
        "YYYY-MM-DD"
  ...
  return (
    <div className="query3-container">
      <h2 className="header334" style={{fontSize:'30px',color:"black",right:"200px"}} ><em>COUNT OF PASSENGERS TRAVELLED TRAINWISE</em> </h2>
